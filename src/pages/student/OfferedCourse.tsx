...
} from "../../redux/features/StudentFeatures/studentCourseManagement.api";
...
const OfferedCourse = () => {
  const { data: offeredCourseData } = useGetAllMyOfferedCoursesQuery(undefined);
  ...
  return (
    <Row gutter={[0, 20]}>
      {modifiedData?.map((item) => {
        return (
          <Col span={24} style={{ border: "solid #d4d4d4 2px" }} key={item}>
